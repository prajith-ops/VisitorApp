              ...
              child: OutlinedButton(
                onPressed: () async {
                  ...
                  if (fname.isEmpty) {
                    valid = false;
                    showMessage(
                        context, "Please enter first name!", Colors.blueAccent);
                  }
                  if (lname.isEmpty) {
                    valid = false;
                    showMessage(
                        context, "Please enter last name!", Colors.blueAccent);
                  }
                  if (purpose.isEmpty) {
                    valid = false;
                  ...
                  if (whomToMeet.isEmpty) {
                    ...
                    showMessage(
                        context,
                        "Please enter whom do you want to meet!",
                        Colors.blueAccent);
                  }
                  ...
                  if (valid) {
                    if (await sendVisitorData(
                      ...
                      showMessage(
                          context, "Failed to add visitor!", Colors.blueAccent);
                    }
                  }
                },
                child: Text(
